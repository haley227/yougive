<?xml version="1.0" encoding="UTF-8"?><cfLuceeConfiguration hspw="b275f03ca6c38007aa9a456d9e31ec6709691b91d7923d8443c0cf3aa593a7f0" salt="820341D6-9A04-4F21-BC960A1A7CBB9C17" version="5.2">
...
<!--	or ask your database distributor 																-->
	...
	<data-sources>
	<data-source allow="511" blob="false" class="com.mysql.jdbc.Driver" clob="false" connectionTimeout="1" custom="useUnicode=true&amp;characterEncoding=UTF-8&amp;useLegacyDatetimeCode=true" database="c25_yougive" dbdriver="MySQL" dsn="jdbc:mysql://{host}:{port}/{database}" host="db1.ioio.com" id="mysql" metaCacheTimeout="60000" name="charityApp" param-delimiter="&amp;" param-leading-delimiter="?" param-separator="=" password="encrypted:cb748aacc66724cd9cf20c51218955593b0ded3cf2c1c8b1301e8c90c8ec2b28a10ba00157bb73bd" port="3306" storage="false" username="hsmith" validate="false"/></data-sources>
