  ...
  <div class="frame">
    <div class="nav">
      <ul class"links">
        ...
        <li class="signup-active" id="reset"><a class="btn" href="forgotten_password.cfm">Reset</a></li>
      </ul>
    </div>
    <div ng-app ng-init="checked = false">
<cfif #url.status# eq 'pwMatchError'>
		<script> alert("Password does not match");</script>
	<cfelseif #url.status# eq 'otCodeError'>
		<script> alert("One time code is incorrect, please try again");</script>
	</cfif>

	
        
	<form class="form-signup" action="forgotten_password_action.cfm" method="post" name="form">
          <label for="email">Email</label>
          <input class="form-styling" type="text" name="email" placeholder="" required/>
          <input type="submit" class="btn-signup" id="reset" value="Reset Password">
	</form>
